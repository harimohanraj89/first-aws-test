...
class TractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tractor" do
    assert_difference('Tractor.count') do
      post tractors_url, params: { tractor: { description: @tractor.description, name: @tractor.name } }
    end
  ...
  test "should update tractor" do
    patch tractor_url(@tractor), params: { tractor: { description: @tractor.description, name: @tractor.name } }
